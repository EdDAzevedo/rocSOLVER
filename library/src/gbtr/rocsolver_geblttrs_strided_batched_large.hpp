...
rocblas_status rocsolver_geblttrs_npvt_strided_batched_large_template(
...
#define X(i1,i2,i3,ibatch) \
	X_[ ((ibatch)-1)*strideX + indx3f(i1,i2,i3, ldx,nb) ]
