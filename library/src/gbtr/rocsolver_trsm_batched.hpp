...
rocblas_status rocsolver_trsm_batched(rocblas_handle handle,
                                              ...
                                              rocblas_int batch_count)
{
    return (rocblas_dtrsm_batched(handle, side, uplo, transA, diag, m, n, alpha, A, lda,
                                          B, ldb, batch_count));
}
...
rocblas_status rocsolver_trsm_batched(rocblas_handle handle,
                                              ...
                                              rocblas_int batch_count)
{
    return (rocblas_strsm_batched(handle, side, uplo, transA, diag, m, n, alpha, A, lda,
                                          B, ldb, batch_count));
}
...
rocblas_status rocsolver_trsm_batched(rocblas_handle handle,
                                              ...
                                              rocblas_int batch_count)
{
    return (rocblas_ztrsm_batched(handle, side, uplo, transA, diag, m, n, alpha, A, lda,
                                          B, ldb, batch_count));
}
...
rocblas_status rocsolver_trsm_batched(rocblas_handle handle,
                                              ...
                                              rocblas_int batch_count)
{
    return (rocblas_ctrsm_batched(handle, side, uplo, transA, diag, m, n, alpha, A, lda,
                                          B, ldb, batch_count));
}
