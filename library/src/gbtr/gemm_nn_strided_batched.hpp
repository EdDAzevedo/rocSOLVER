...
template <typename T>
GLOBAL_FUNCTION void gemm_nn_strided_batched_kernel(rocblas_int const m,
                                                    rocblas_int const n,
                                                    rocblas_int const k,
...
{
    rocblas_stride ci_A, cj_A, ck_A;
    rocblas_stride ci_B, cj_B, ck_B;
    rocblas_stride ci_C, cj_C, ck_C;
